...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-01-2023 a las 00:13:54
...
CREATE TABLE `categorias` (
  ...
  `fechaNacimiento` varchar(100) COLLATE utf8_bin NOT NULL
...
INSERT INTO `categorias` (`idCategoria`, `primerNombre`, `primerApellido`, `edad`, `ciudad`, `barrio`, `correo`, `telefono`, `fechaNacimiento`) VALUES
('123', 'Iván', 'Mejia', 23, 'Ipiales', 'libertad', 'camilomp100@hotmail.com', '3175791350', 'junio 20 1');
